...
Public Class President_vote
    ...
    Private Sub President_Load(sender As Object, e As EventArgs) Handles MyBase.Load
       ...
       & "database=" & Trim(Settings.dbname.Text) & ";"
        ...
        Try
            With cmd
                .Connection = con
                .CommandText = "Select `NAME`, `ID` FROM `candidate` WHERE POSITION= 'PRESIDENT' "
            End With
            With ListBox1
    ...
    Private Sub ComboBox1_MouseClick(sender As Object, e As MouseEventArgs)
    ...
    Private Sub nextfrm_Click(sender As Object, e As EventArgs) Handles nextfrm.Click
        ...
        Else
            dataform.president.Text = CID.Text
            dataform.pres.Text = CSNAME.Text
