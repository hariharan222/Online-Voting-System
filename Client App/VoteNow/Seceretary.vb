...
Public Class Seceretary
    ...
    Private Sub Seceretary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            With cmd
                .Connection = con
                .CommandText = "Select `NAME`, `ID` FROM `candidate` WHERE POSITION= 'SECERETARY' "
            End With
            With ListBox1
    ...
    Private Sub nextfrm_Click(sender As Object, e As EventArgs) Handles nextfrm.Click
        ...
        Else
            dataform.seceretary.Text = CID.Text
            dataform.sec.Text = CSNAME.Text
