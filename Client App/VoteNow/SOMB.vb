...
Public Class SOMB
    ...
    Private Sub SOMB_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            With cmd
                .Connection = con
                .CommandText = "Select `NAME`, `ID` FROM `candidate` WHERE POSITION= 'SOMB REPRESENTATIVE' "
            End With
            With ListBox1
    ...
    Private Sub nextfrm_Click(sender As Object, e As EventArgs) Handles nextfrm.Click
        ...
        Else
            If User.student.Text <> "Malaysia" Then
                dataform.SOMB.Text = CID.Text
                irep.Show()
                Me.Close()
            Else
                dataform.SOMB.Text = CID.Text
                dataform.sombn.Text = CSNAME.Text
